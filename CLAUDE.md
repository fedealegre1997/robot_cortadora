...
**Formato de mensajes:**
- `motion_cmd = [cmd_id, L_dir, L_pwm, R_dir, R_pwm, T_ms]` — T_ms=0 significa continuo
- `motion_status = [cmd_id, state, L_dir, L_pwm, R_dir, R_pwm, remaining_ms]`

**Estados del motor:** `IDLE=0, ACCEPTED=1, EXECUTING=2, DONE=3, ABORTED=4, ERROR=5`

**Direcciones:** `FORWARD=1, REVERSE=0`
